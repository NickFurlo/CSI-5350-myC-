Eric Cai and Mingshuai Ye
CSE 5350

<stmt> ::= <func_dec> | <func_call> | <loop> | <if_stmt> | <var_dec> | <array_dec> | <assignexpr> | <boolexpr> 

//Variable declaration
<var_dec> ::= <typename> id | <typename> id = <boolexpr> //Set the variable name or assign an expression to the variable  NEW
